...
function Slycer:CreateWindow(GameName)
	...
	local PlaceTopBar_1 = Instance.new("Frame")
	local UIStroke_17 = Instance.new("UIStroke")
	local PlaceTitle_1 = Instance.new("TextLabel")
	local UIPadding_18 = Instance.new("UIPadding")
	local PlaceMain_1 = Instance.new("Frame")
	local PlaceId_1 = Instance.new("TextLabel")
	local PlaceName_1 = Instance.new("TextLabel")
	...
	MinimizeBtn_1.Position = UDim2.new(0.92636764, 0,0, 0)
	MinimizeBtn_1.Size = UDim2.new(0, 21,0, 21)
	MinimizeBtn_1.Font = Enum.Font.Code
	MinimizeBtn_1.Text = "-"
	MinimizeBtn_1.TextColor3 = Color3.fromRGB(200,200,200)
	MinimizeBtn_1.TextSize = 14
	MinimizeBtn_1.TextStrokeTransparency = 0
	...
	PlaceHolder_1.BorderColor3 = Color3.fromRGB(0,0,0)
	PlaceHolder_1.BorderSizePixel = 0
	PlaceHolder_1.Position = UDim2.new(1.00999999, 0,0, 158)
	PlaceHolder_1.Size = UDim2.new(0, 172,0, 76)

	UIStroke_16.Parent = PlaceHolder_1
	UIStroke_16.Color = Color3.fromRGB(80,80,80)
	UIStroke_16.Thickness = 1

	PlaceTopBar_1.Name = "PlaceTopBar"
	PlaceTopBar_1.Parent = PlaceHolder_1
	PlaceTopBar_1.BackgroundColor3 = Color3.fromRGB(37,37,37)
	PlaceTopBar_1.BorderColor3 = Color3.fromRGB(0,0,0)
	PlaceTopBar_1.BorderSizePixel = 0
	PlaceTopBar_1.Size = UDim2.new(0, 172,0, 21)

	UIStroke_17.Parent = PlaceTopBar_1
	UIStroke_17.Color = Color3.fromRGB(80,80,80)
	UIStroke_17.Thickness = 1

	PlaceTitle_1.Name = "PlaceTitle"
	PlaceTitle_1.Parent = PlaceTopBar_1
	PlaceTitle_1.BackgroundColor3 = Color3.fromRGB(255,255,255)
	PlaceTitle_1.BackgroundTransparency = 1
	PlaceTitle_1.BorderColor3 = Color3.fromRGB(0,0,0)
	PlaceTitle_1.BorderSizePixel = 0
	PlaceTitle_1.Size = UDim2.new(0, 172,0, 21)
	PlaceTitle_1.Font = Enum.Font.Code
	PlaceTitle_1.Text = "Current Place"
	PlaceTitle_1.TextColor3 = Color3.fromRGB(200,200,200)
	PlaceTitle_1.TextSize = 13
	PlaceTitle_1.TextStrokeTransparency = 0
	PlaceTitle_1.TextXAlignment = Enum.TextXAlignment.Left

	UIPadding_18.Parent = PlaceTitle_1
	UIPadding_18.PaddingLeft = UDim.new(0,6)

	PlaceMain_1.Name = "PlaceMain"
	PlaceMain_1.Parent = PlaceHolder_1
	PlaceMain_1.BackgroundColor3 = Color3.fromRGB(255,255,255)
	PlaceMain_1.BackgroundTransparency = 1
	PlaceMain_1.BorderColor3 = Color3.fromRGB(0,0,0)
	PlaceMain_1.BorderSizePixel = 0
	PlaceMain_1.Position = UDim2.new(0, 0,0.304347813, 0)
	PlaceMain_1.Size = UDim2.new(0, 172,0, 48)

	PlaceId_1.Name = "PlaceId"
	PlaceId_1.Parent = PlaceMain_1
	PlaceId_1.BackgroundColor3 = Color3.fromRGB(255,255,255)
	PlaceId_1.BackgroundTransparency = 1
	PlaceId_1.BorderColor3 = Color3.fromRGB(0,0,0)
	PlaceId_1.BorderSizePixel = 0
	PlaceId_1.Position = UDim2.new(0, 56,0, 24)
	PlaceId_1.Size = UDim2.new(0, 109,0, 18)
	PlaceId_1.ClipsDescendants = true
	PlaceId_1.Font = Enum.Font.Code
	PlaceId_1.Text = game.PlaceId
	PlaceId_1.TextColor3 = Color3.fromRGB(120,120,120)
	PlaceId_1.TextSize = 12
	PlaceId_1.TextStrokeTransparency = 0
	PlaceId_1.TextXAlignment = Enum.TextXAlignment.Left

	PlaceName_1.Name = "PlaceName"
	PlaceName_1.Parent = PlaceMain_1
	PlaceName_1.BackgroundColor3 = Color3.fromRGB(255,255,255)
	PlaceName_1.BackgroundTransparency = 1
	PlaceName_1.BorderColor3 = Color3.fromRGB(0,0,0)
	PlaceName_1.BorderSizePixel = 0
	PlaceName_1.Position = UDim2.new(0.325582802, 0,0.0625, 3)
	PlaceName_1.Size = UDim2.new(0, 109,0, 18)
	PlaceName_1.ClipsDescendants = true
	PlaceName_1.Font = Enum.Font.Code
	PlaceName_1.Text = game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name
	PlaceName_1.TextColor3 = Color3.fromRGB(120,120,120)
	...
	PlaceHolder_1.BorderSizePixel = 0
	PlaceHolder_1.Position = UDim2.new(1.00999999, 0,0, 158)
	PlaceHolder_1.Size = UDim2.new(0, 172,0, 70)
	...
	PlaceId_1.BorderColor3 = Color3.fromRGB(0,0,0)
	PlaceId_1.BorderSizePixel = 0
	PlaceId_1.Position = UDim2.new(0, 5,0, 24)
	PlaceId_1.Size = UDim2.new(0, 109,0, 18)
	PlaceId_1.ClipsDescendants = true
	PlaceId_1.Font = Enum.Font.Code
	PlaceId_1.Text = game.PlaceId
	...
	PlaceName_1.BorderColor3 = Color3.fromRGB(0,0,0)
	PlaceName_1.BorderSizePixel = 0
	PlaceName_1.Position = UDim2.new(0.0290711876, 0,0.0625, 3)
	PlaceName_1.Size = UDim2.new(0, 109,0, 18)
	PlaceName_1.ClipsDescendants = true
	PlaceName_1.Font = Enum.Font.Code
	PlaceName_1.Text = game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name
